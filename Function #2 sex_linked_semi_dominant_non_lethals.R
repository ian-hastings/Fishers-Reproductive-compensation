...
Find_sex_linked_equilib_freq<-function(q, max_gens, precision, h, s, CR, u ){ 
...
#here are the data the function will return
...
norm=brood_male_genotype[1,1]+brood_male_genotype[1,2]+brood_female_genotype[1,1]+brood_female_genotype[1,2]+brood_female_genotype[1,3]
check_3_1=norm # set s=0 and this should sum to 1. Checking I have gone the mutations correct

brood_male_genotype[1,1]=brood_male_genotype[1,1]/norm
brood_male_genotype[1,2]=brood_male_genotype[1,2]/norm

brood_female_genotype[1,1]=brood_female_genotype[1,1]/norm
brood_female_genotype[1,2]=brood_female_genotype[1,2]/norm
brood_female_genotype[1,3]=brood_female_genotype[1,3]/norm
...
norm=brood_male_genotype[2,1]+brood_male_genotype[2,2]+brood_female_genotype[2,1]+brood_female_genotype[2,2]+brood_female_genotype[2,3]
check_3_2=norm # set s=0 and this should sum to 1. Checking I have gone the mutations correct

brood_male_genotype[2,1]=brood_male_genotype[2,1]/norm
brood_male_genotype[2,2]=brood_male_genotype[2,2]/norm

brood_female_genotype[2,1]=brood_female_genotype[2,1]/norm
brood_female_genotype[2,2]=brood_female_genotype[2,2]/norm
brood_female_genotype[2,3]=brood_female_genotype[2,3]/norm
...
norm=brood_male_genotype[3,1]+brood_male_genotype[3,2]+brood_female_genotype[3,1]+brood_female_genotype[3,2]+brood_female_genotype[3,3]
check_3_3=norm # set s=0 and this should sum to 1. Checking I have gone the mutations correct

brood_male_genotype[3,1]=brood_male_genotype[3,1]/norm
brood_male_genotype[3,2]=brood_male_genotype[3,2]/norm

brood_female_genotype[3,1]=brood_female_genotype[3,1]/norm
brood_female_genotype[3,2]=brood_female_genotype[3,2]/norm
brood_female_genotype[3,3]=brood_female_genotype[3,3]/norm
...
norm=brood_male_genotype[4,1]+brood_male_genotype[4,2]+brood_female_genotype[4,1]+brood_female_genotype[4,2]+brood_female_genotype[4,3]
check_3_4=norm # set s=0 and this should sum to 1. Checking I have gone the mutations correct

brood_male_genotype[4,1]=brood_male_genotype[4,1]/norm
brood_male_genotype[4,2]=brood_male_genotype[4,2]/norm

brood_female_genotype[4,1]=brood_female_genotype[4,1]/norm
brood_female_genotype[4,2]=brood_female_genotype[4,2]/norm
brood_female_genotype[4,3]=brood_female_genotype[4,3]/norm
...
norm=brood_male_genotype[5,1]+brood_male_genotype[5,2]+brood_female_genotype[5,1]+brood_female_genotype[5,2]+brood_female_genotype[5,3]
check_3_5=norm # set s=0 and this should sum to 1. Checking I have gone the mutations correct

brood_male_genotype[5,1]=brood_male_genotype[5,1]/norm
brood_male_genotype[5,2]=brood_male_genotype[5,2]/norm

brood_female_genotype[5,1]=brood_female_genotype[5,1]/norm
brood_female_genotype[5,2]=brood_female_genotype[5,2]/norm
brood_female_genotype[5,3]=brood_female_genotype[5,3]/norm
...
norm=brood_male_genotype[6,1]+brood_male_genotype[6,2]+brood_female_genotype[6,1]+brood_female_genotype[6,2]+brood_female_genotype[6,3]
check_3_6=norm # set s=0 and this should sum to 1. Checking I have gone the mutations correct

brood_male_genotype[6,1]=brood_male_genotype[6,1]/norm
brood_male_genotype[6,2]=brood_male_genotype[6,2]/norm

brood_female_genotype[6,1]=brood_female_genotype[6,1]/norm
brood_female_genotype[6,2]=brood_female_genotype[6,2]/norm
brood_female_genotype[6,3]=brood_female_genotype[6,3]/norm
...
if((check_1a> max_lim) | (check_1a<min_lim))
  return_data$error_code <- 1
if((check_1b> max_lim) | (check_1b<min_lim))
  return_data$error_code <- 1
...
new_adult_male_freq[1]=new_adult_male_freq[1]+mating_freq[mating_type]*Size_brood_after_RC[mating_type]*brood_male_genotype[mating_type,1]
new_adult_male_freq[2]=new_adult_male_freq[2]+mating_freq[mating_type]*Size_brood_after_RC[mating_type]*brood_male_genotype[mating_type,2]

new_adult_female_freq[1]=new_adult_female_freq[1]+mating_freq[mating_type]*Size_brood_after_RC[mating_type]*brood_female_genotype[mating_type,1]
new_adult_female_freq[2]=new_adult_female_freq[2]+mating_freq[mating_type]*Size_brood_after_RC[mating_type]*brood_female_genotype[mating_type,2]
new_adult_female_freq[3]=new_adult_female_freq[3]+mating_freq[mating_type]*Size_brood_after_RC[mating_type]*brood_female_genotype[mating_type,3]
}
...
return_data$check_3_1 <- check_3_1  #NB the check_3 should only sum to zero when s=0 (i.e. no selection). It checks the mutation calulations are correct
